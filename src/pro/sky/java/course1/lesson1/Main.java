...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Книга1- " + book1.getBookName() + "Автор: " + author1.toString() + " " + "год: " + book1.getPublishingYear());
        System.out.println("Книга2- " + book2.getBookName() + "Автор: " + author2.toString() + " " + "год: " + book2.getPublishingYear());
        book2.setPublishingYear(3333);
        System.out.println("Исправлене года второй книги");
        System.out.println("Книга2- " + book2.getBookName() + "Автор: " + author2.toString() + " "
